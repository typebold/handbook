...
Nos referimos a Workflow y Stage de tipo secuencial cuando son dependientes uno de otros, no puedo estar el Stage 2 sino complete el Stage 1, además los nodos pueden ser secuenciales, dado que existe un flujo para la entrar de un nodo a otro.
